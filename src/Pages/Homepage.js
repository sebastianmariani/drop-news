    ...
    return (
        <div className="homepageContent">
            <div className="homepageText">
                <h1>DR<br/>
                    <span>
                        <svg className="dropHomepage" width="30" height="37" viewBox="0 0 14 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="paragraphs">
                    <h3>The pace of nowadays news is becoming unsustainable,<br/>
                    ...
                    <h3>We are here to limit the the quantity of distraction<br/>
                        ...
                        <span className="linkContainer"><Link className="link" to="newspage">Start now</Link></span>
                </div>
            </div>
            <img width="30%" height="100%" alt="Lamp" src={img}></img>
        </div>
    )
}
